...
<<COMMENT
  ...
  sudo pacman -Suy --needed --noconfirm cmake mingw-w64-gcc raylib wget curl openssh docker docker-compose ollama ufw fastfetch
...
<<COMMENT
  ...
  sudo flatpak install flathub org.upscayl.Upscayl com.valvesoftware.Steam com.heroicgameslauncher.hgl -y
COMMENT
