...
pacman -Syu --needed efibootmgr grub networkmanager pipewire-pulse jack2 vulkan-radeon lib32-vulkan-radeon wine wine-mono libappimage unzip gstreamer gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly libretro-bsnes libretro-mgba
...
pacman -Syu --needed hyprland waybar firefox gnome-disk-utility gnome-system-monitor alacritty nautilus rofi pavucontrol krita blender lmms chromium mangohud steam retroarch
...
mkdir -p ${USERHOME}/Desktop ${USERHOME}/Documents ${USERHOME}/Downloads ${USERHOME}/Music ${USERHOME}/Pictures ${USERHOME}/Projects ${USERHOME}/Videos ${USERHOME}/Retro
...
flatpak install flathub org.libreoffice.LibreOffice org.gimp.GIMP org.inkscape.Inkscape com.obsproject.Studio org.localsend.localsend_app -y
